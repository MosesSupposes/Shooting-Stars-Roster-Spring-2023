...
var $author$project$Roster$currentRoster = _List_fromArray(
	[
		{backupRole: $elm$core$Maybe$Nothing, jerseyNumber: $elm$core$Maybe$Nothing, name: 'Coach Wavy', phoneNumber: '(651) 353-7163', primaryRole: $author$project$Roster$Coach},
		{
		backupRole: $elm$core$Maybe$Just($author$project$Roster$SG),
		jerseyNumber: $elm$core$Maybe$Just(6),
		name: 'Michael',
		phoneNumber: '(612) 986-5405',
		primaryRole: $author$project$Roster$SF
	},
		{
		backupRole: $elm$core$Maybe$Just($author$project$Roster$PF),
		jerseyNumber: $elm$core$Maybe$Just(8),
		name: 'Moses',
		phoneNumber: '(929) 389-7608',
		primaryRole: $author$project$Roster$SF
	}
	]);
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{roster: $author$project$Roster$currentRoster},
...
var $author$project$Roster$jerseyToString = function (jersey) {
	if (jersey.$ === 'Just') {
		var jrsy = jersey.a;
		return $elm$core$String$fromInt(jrsy);
	} else {
		return 'N/A';
	}
};
